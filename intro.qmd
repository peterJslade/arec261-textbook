...
- **Don't skip the "why" sections.** While you are learning by doing, you should also note that data analysis is *not* about coming up with the *right* number.  It is about being able to explain numbers. Don't simply learn how to calcualte a standard deviation -- focus on the meaning of this number.  This is what you will be tested on.  
- **Use the external resources.** If you don't understand a concept or an Excel command, often the best thing is to have this concept or command explained to you in multiple ways.  Forunately, there are a near infinite number of resources that cover the same topics that I cover in this book. In each section, I provide a list of these resources.  
