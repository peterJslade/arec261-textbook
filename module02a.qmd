...
![After running the script, the **console** shows the results and the **Variables** pane lists the objects that were created. Running the code is what makes things happen.](images/positron_script_after_run.png){#fig-script-after .screenshot}
