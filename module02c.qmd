...
In Excel, this work happens in a mix of formulas, filters, and manual edits. In R, it happens in a script, which means it is reproducible and easy to re-run.

You met the `dplyr` verbs in @sec-dplyr-verbs.  This chapter is about the shape the data needs to be in before they are much use.
