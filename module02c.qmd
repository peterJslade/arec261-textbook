...
7. Read an R error message and track down what caused it.
:::
...
### When you are still stuck {.unnumbered}

Restart R and run the script from the top in a fresh session. A surprising number of problems are order problems: the script depends on an object that was created in the console, or on an earlier version of a data frame that has since been overwritten. A script that works from a clean start (@sec-good-scripts) has none of these.
