...
#| fig-width: 5.4
#| fig-height: 2.9
#| fig-cap: "Wheat yield, barley yield, spring wheat seeded acres and soil zone for Saskatchewan risk zones, 2025. Zones 22 and 23 are omitted for lack of a soil-zone assignment. [Source: @scic_smp.]{.fig-source}"
...
### Be intentional with colour {.unnumbered}
...
#| fig-width: 6.4
#| fig-height: 2.8
#| fig-cap: "Spring wheat and barley yield in Saskatchewan's 23 risk zones. [Source: @scic_smp.]{.fig-source}"
fig_scatter(yields)
```
...
### Pie charts: show a simple share {#sec-pie-caution .unnumbered}
...
- **Cole Nussbaumer Knaflic, *Storytelling with Data*** -- a practical book on choosing and decluttering charts, available through the USask Library. Her [blog](https://www.storytellingwithdata.com/blog) continues the book with short worked examples.
