...
**(a)** Use one `mutate()` to add `total_bu`, each result's total production in bushels (acres times yield), saving the result.

**(b)** Sort by `total_bu`, largest first, and report the top municipality and variety.

**(c)** In a comment: the highest-yielding result in the data is not the top producer. What does it take to top this list?
