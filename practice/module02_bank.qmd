...
*From here on, use the full eight-crop file: read [`rm_yields_1990_2025.csv`](data/rm_yields_1990_2025.csv) into an object called `rm_yields` at the start of your Section 3 block. These questions use one function at a time; save intermediate results to objects where a later part needs them.*
