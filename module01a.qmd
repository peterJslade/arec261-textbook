...
(The embedded workbooks ask you to sign in with a Microsoft account. Any Microsoft account works -- it does not have to be your USask one.)
:::
...
::: {.video-callout}
::: {.callout-note collapse="true" title="Video walkthrough of this section's workbook"}
...
[Open online](https://usaskca1-my.sharepoint.com/personal/pjs998_usask_ca/_layouts/15/Doc.aspx?sourcedoc=%7Bb7f0c21d-352c-47ea-9eed-a82a2e30f8e9%7D&action=default) (File → Save a Copy to view formulas and edit). The workbook includes practice sheets to fill in yourself.  
:::
...
[Open online](https://usaskca1-my.sharepoint.com/personal/pjs998_usask_ca/_layouts/15/Doc.aspx?sourcedoc=%7B58a2f02f-69cb-46fa-ba96-4768f4ef22d9%7D&action=default) (File → Save a Copy to view formulas and edit). The workbook includes a practice sheet to fill in yourself.
:::
...
Many Excel functions take a range as their input. Three of them cover most of what you will
do in this course:
...
They all follow the same shape -- a name, a bracket, and a range -- which is worth noticing
now, because almost every function you meet later reads the same way.
...
[Open online](https://usaskca1-my.sharepoint.com/personal/pjs998_usask_ca/_layouts/15/Doc.aspx?sourcedoc=%7B694f423f-e665-460b-8aee-2f68834a4ee2%7D&action=default) (File → Save a Copy to view formulas and edit). The workbook includes a practice sheet to fill in yourself.
:::
...
Notice that the workbook averages acres and bushels but not the yield column. Averaging
yields across fields of different sizes is its own problem, and we come back to it in
@sec-central-tendency.
