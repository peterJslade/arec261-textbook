...
Return to the five wheat fields from the [ranges and functions section](module01a.qmd#sec-sum), with acres in `B5:B9` and yields in `C5:C9`. Suppose you want to answer: *what was the average yield across the whole farm?*

The tempting move is a plain `=AVERAGE(C5:C9)`, which gives 52.5 bu/ac. But that treats the 95-acre Creek field exactly the same as the 310-acre Home field -- as if each field were one "vote." That is not what "the average yield across the farm" means. A field three times the size should count three times as much.
...
where $x_i$ is each field's yield and $w_i$ is its acres (the **weight**). The workbook in @sec-sum already does this the simple way, dividing total bushels by total acres. `SUMPRODUCT` does the multiplying and adding in one step, which is handy when you have no bushels column:

```
=SUMPRODUCT(C5:C9, B5:B9) / SUM(B5:B9)
```
...
::: {.excel-embed}
<iframe width="402" height="700" frameborder="0" scrolling="no" src="https://usaskca1-my.sharepoint.com/personal/pjs998_usask_ca/_layouts/15/Doc.aspx?sourcedoc=%7Bd5cfe169-4900-4832-800c-8c721cc6690d%7D&action=embedview&ActiveCell='Centre'!A1&wdAllowInteractivity=False&wdDownloadButton=True&wdInConfigurator=True"></iframe>
:::

[Download this workbook](textbook_examples/Sask_barley_varieties_2025.xlsx) · [Open online](https://usaskca1-my.sharepoint.com/personal/pjs998_usask_ca/_layouts/15/Doc.aspx?sourcedoc=%7Bd5cfe169-4900-4832-800c-8c721cc6690d%7D&action=default) (File → Save a Copy to view formulas and edit) · the **Centre** tab
:::
...
```
=QUARTILE.INC(D5:D40,1) - 1.5*(QUARTILE.INC(D5:D40,3) - QUARTILE.INC(D5:D40,1))
```
...
::: {.excel-embed}
<iframe width="402" height="700" frameborder="0" scrolling="no" src="https://usaskca1-my.sharepoint.com/personal/pjs998_usask_ca/_layouts/15/Doc.aspx?sourcedoc=%7Bd5cfe169-4900-4832-800c-8c721cc6690d%7D&action=embedview&ActiveCell='Location'!A1&wdAllowInteractivity=False&wdDownloadButton=True&wdInConfigurator=True"></iframe>
:::

[Download this workbook](textbook_examples/Sask_barley_varieties_2025.xlsx) · [Open online](https://usaskca1-my.sharepoint.com/personal/pjs998_usask_ca/_layouts/15/Doc.aspx?sourcedoc=%7Bd5cfe169-4900-4832-800c-8c721cc6690d%7D&action=default) (File → Save a Copy to view formulas and edit) · the **Location** tab
:::
...
Suppose, for example, that one of the tightly clustered fields in @fig-spread-hail experiences a hailstorm that wipes out its crop. That single field increases the range from 8.9 to 40.6 bu/ac -- more than quadrupling it -- even though only one of the 30 fields has changed. The interquartile range, described below, barely moves, from 3.4 to 3.6 bu/ac, because it focuses on the middle half of the data rather than the extremes.
...
::: {.workbook-callout}
The **Spread** tab works through all five measures on the barley varieties, so you can see how each responds to the same data.

::: {.excel-embed}
<iframe width="402" height="700" frameborder="0" scrolling="no" src="https://usaskca1-my.sharepoint.com/personal/pjs998_usask_ca/_layouts/15/Doc.aspx?sourcedoc=%7Bd5cfe169-4900-4832-800c-8c721cc6690d%7D&action=embedview&ActiveCell='Spread'!A1&wdAllowInteractivity=False&wdDownloadButton=True&wdInConfigurator=True"></iframe>
:::

[Download this workbook](textbook_examples/Sask_barley_varieties_2025.xlsx) · [Open online](https://usaskca1-my.sharepoint.com/personal/pjs998_usask_ca/_layouts/15/Doc.aspx?sourcedoc=%7Bd5cfe169-4900-4832-800c-8c721cc6690d%7D&action=default) (File → Save a Copy to view formulas and edit) · the **Spread** tab
:::
...
::: {.excel-embed}
<iframe width="402" height="700" frameborder="0" scrolling="no" src="https://usaskca1-my.sharepoint.com/personal/pjs998_usask_ca/_layouts/15/Doc.aspx?sourcedoc=%7Bd5cfe169-4900-4832-800c-8c721cc6690d%7D&action=embedview&ActiveCell='Histogram'!A1&wdAllowInteractivity=False&wdDownloadButton=True&wdInConfigurator=True"></iframe>
:::

[Download this workbook](textbook_examples/Sask_barley_varieties_2025.xlsx) · [Open online](https://usaskca1-my.sharepoint.com/personal/pjs998_usask_ca/_layouts/15/Doc.aspx?sourcedoc=%7Bd5cfe169-4900-4832-800c-8c721cc6690d%7D&action=default) (File → Save a Copy to view formulas and edit) · the **Histogram** tab
:::
