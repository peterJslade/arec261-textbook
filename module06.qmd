...
Modules 1-4 were about one variable at a time: how is yield distributed? what is the mean? the spread? With Module 5 we start asking about *relationships*: how does yield change with acres? does fertilizer application predict yield? is price related to quality?
...
4. **Selection.** The dataset was assembled in a way that induces a spurious correlation. (We will see examples of this in Module 9.)
