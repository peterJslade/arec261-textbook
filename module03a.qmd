...
1. [`elevator_tickets.csv`](practice/data/elevator_tickets.csv) -- twenty grain-delivery tickets, with identifier columns that spreadsheets like to mangle.
...
Note that when we download the data it is best to always store a copy of the data on our computer.  This saves us from having to download the data multiple times, and protects us against the data provider altering their url or removing the data completely.
