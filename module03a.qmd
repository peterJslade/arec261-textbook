...
![The tickets file opened by double-clicking. Ticket `00001` has become `1`, the permit book number is in scientific notation, and lot `3-2` is now a date.](images/csv_doubleclick.png){#fig-csv-doubleclick .screenshot}
-->
...
![Step 3 of Text to Columns: each column gets a type, and **Advanced** sets the decimal mark.](images/csv_text_to_columns.png){#fig-csv-text-to-columns .screenshot}
-->
