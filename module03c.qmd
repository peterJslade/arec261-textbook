...
Read the three files, standardizing the lookup and station column names on the way in (@sec-clean-names):
...
In R, text keys are sensitive to both case and spaces: `"canola"`, `"Canola"` and `"Canola "` are three different keys. These differences have to be reconciled before the join (@sec-categories).
