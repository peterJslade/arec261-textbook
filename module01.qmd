...
A complex workbook should have a **README or contents** as the first worksheet.  This explains what the workbook is, who made it, when, what the inputs are, and what each other sheet contains. It can also contain *links* to the other worksheets. 
