...
- Summarize the *centre* of data with the mean, median, and mode — and choose the right one
...
- Describe *position* with percentiles and quartiles
- Measure *spread* with the range, variance, standard deviation, and coefficient of variation
- Interpret a distribution's shape from a histogram and a box plot
...
- **`.xlsx`** — The default modern Excel format. Can contain multiple worksheets, formulas, formatting, charts, and PivotTables. This is what you save your *working* Excel files as. (A variant, `.xlsm`, additionally allows macros; a plain `.xlsx` cannot store them.)
