...
If a different explanation would help, try these. (You do not need any of them — they are optional "go deeper" material.)
...
- **Video — Khan Academy:** "Mean, median, and mode" (search Khan Academy Statistics → *Summarizing quantitative data*). Clear, beginner-friendly, no Excel required.
- **Video — ExcelIsFun (YouTube):** search "ExcelIsFun AVERAGE MEDIAN MODE" for a hands-on Excel walkthrough.

*(Instructor: verify each link before term; YouTube search terms are given rather than fixed URLs so they stay current.)*
:::
