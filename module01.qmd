...
![](images/spread_wide.png){#fig-spread-wide}

![](images/spread_tight.png){#fig-spread-tight}

Thirty farm yields, each dot one field. Both sets average 40 bu/ac, but their spread is very different.
:::
...
![One hailed-out field. The range explodes; the interquartile range hardly notices.](images/spread_hail.png){#fig-spread-hail}
...
![](images/shape_bimodal.png){#fig-shape-bimodal}

![](images/shape_unimodal.png){#fig-shape-unimodal}

Two datasets with the same mean and the same range, but very different shapes.
:::
