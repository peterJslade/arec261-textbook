...
## Visualizing the Shape of the Data {#sec-charts}

Numbers describe a distribution; a picture *shows* it. Two charts do most of the work when you are exploring a single variable: a **histogram**, which shows the shape of a distribution, and a **box and whisker plot**, which shows its centre, spread, and outliers at a glance — and lets you compare distributions side by side. Both are visual restatements of the statistics you just computed. (Charts for *comparing categories* or showing change over time — bar, line, and scatter plots — are covered in @sec-module4.)
