...
- **Date evolving files** in `YYYY-MM-DD` form (e.g. `2026-09-15`) — it sorts correctly alphabetically.  This works much better than saying `report_DRAFT.xlsx`, `report_Work_in_Progress.xlsx`, and `report_FINAL.xlsx`.
